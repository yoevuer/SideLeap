...
object ActionCatalog {
    ...
    val definitions: List<ActionDefinition> = listOf(
        ...
        ActionDefinition(GlobalActions.PREVIOUS_APP, ActionCategory.NAVIGATION, ActionConfigKind.NONE,
        ...
        ActionDefinition(GlobalActions.POINTER, ActionCategory.TOOL, ActionConfigKind.NONE,
        ...
        ActionDefinition(GlobalActions.HIDE_GESTURE_BUTTON, ActionCategory.SYSTEM, ActionConfigKind.NONE,
            R.string.action_hide_gesture_button, Icons.Default.Gesture),
        ActionDefinition(GlobalActions.VOLUME_SCRUB, ActionCategory.SYSTEM, ActionConfigKind.NONE,
