...
object ActionCatalog {
    ...
    val definitions: List<ActionDefinition> = listOf(
        ...
        ActionDefinition(GlobalActions.OPEN_APP_ACTIVITY, ActionCategory.TOOL, ActionConfigKind.OPEN_APP_OR_URL, "open_activity", "open_activity"),
        ActionDefinition(GlobalActions.OPEN_URL, ActionCategory.TOOL, ActionConfigKind.OPEN_APP_OR_URL, "open_url", "open_url"),
