...
sealed interface IconResizeUiEvent

class IconResizeVM(
    private val ids: List<String>
) : BaseComposeVM<IconResizeUiState, IconResizeUiEvent>() {

    override val initialState: IconResizeUiState = IconResizeUiState()
            ...
            it.copy(
                bgColors = it.bgColors.toMutableMap().apply {
                    ...
                    if (bgColor != null) {
                        ...
                        put(it.selectedId, IconResizeUiState.BgColor(enabled = enabled, color = defaultColor))
                    }
                }
            )
        }
            ...
            it.copy(
                bgColors = it.bgColors.toMutableMap().apply {
                    ...
                    if (bgColor != null) {
                        ...
                        put(it.selectedId, IconResizeUiState.BgColor(enabled = true, color = color))
                    }
                }
            )
        }
            ...
            ConfigProvider
                ...
                .collectLatest { advancedSettings ->
                    ...
                    updateUiState {
                        ...
                        val bgColors = mutableMapOf<String, IconResizeUiState.BgColor>()
                        QuickLaunchFacade.getIconBgColorCacheSnapshot().forEach { (id, bgColor) ->
                            if (bgColor != 0) {
                                bgColors[id] = IconResizeUiState.BgColor(true, Color(bgColor))
                            }
                        }
