...
private val actionTextResMap: Map<String, Int> = mapOf(
    ...
    GlobalActions.WECHAT_SCAN to R.string.action_wechat_scan,
    GlobalActions.WECHAT_PAY to R.string.action_wechat_pay_simulate_click,
    GlobalActions.ALIPAY_SCAN to R.string.action_alipay_scan,
    GlobalActions.ALIPAY_PAY to R.string.action_alipay_pay,
...
private val actionIconMap: Map<String, Any> = mapOf(
    ...
    GlobalActions.WECHAT_SCAN to R.drawable.wechat_scan,
    GlobalActions.WECHAT_PAY to R.drawable.wechat_paycode,
    GlobalActions.ALIPAY_SCAN to R.drawable.alipay_scan,
    GlobalActions.ALIPAY_PAY to R.drawable.alipay_paycode,
